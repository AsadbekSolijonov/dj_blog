...
EMAIL_HOST_PASSWORD = 'rewvaycivacympic'
    ...
    'default': {
        'toolbar': {
            'items': [
                ...
                'imageUpload', 'mediaEmbed',  # YouTube plugin
            ],
        },
        'mediaEmbed': {
            'previewsInData': True  # video embed previewni CKEditor ichida ko‘rsatadi
        }
    },
    'extends': {
        'blockToolbar': [
        ...
        'toolbar': {
            'items': [
                ...
                'blockQuote', 'imageUpload', 'mediaEmbed', '|',  # YouTube plugin
